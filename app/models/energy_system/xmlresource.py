'''
A copy of XMIResource, with minor changes (see comments made by edwinmatthijsen/ewoudwerkman)
...
class XMLResource(XMIResource):
    ...
    def save(self, output=None, options=None):
        ...
        # remove XMI version in XML serialization
