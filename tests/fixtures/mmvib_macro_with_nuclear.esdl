...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" name="Solar panel" description="Solar panel" esdlVersion="v2102" version="19" id="3beab53e-f956-45ac-9fd0-05ba03fb3b84">
  <energySystemInformation xsi:type="esdl:EnergySystemInformation" id="1b789820-f90f-459f-87b2-59fc4a385d58">
    ...
    <dataSources xsi:type="esdl:DataSources" id="144a4661-4496-4904-b00a-fa2a9ffb66d5">
      <dataSource xsi:type="esdl:DataSource" name="NewDataSource" id="91ce2a4f-0b8e-4114-b163-ef35ef9365a0" description="dfsdf_asda"/>
    </dataSources>
  ...
  <instance xsi:type="esdl:Instance" id="1cb40fb5-7c19-43b0-b88d-406aaaf2fbd3">
    ...
    <area xsi:type="esdl:Area" id="nl2019" name="Nederland">
      ...
      <asset xsi:type="esdl:MobilityDemand" technicalLifetime="13.0" power="162737037.48245242" originalIdInSource="transport_car_using_hydrogen" name="MobilityDemand_7a45" type="CAR" id="7a45670d-5aba-405a-94e6-47ce6c141435" efficiency="1.35454" fuelType="HYDROGEN" aggregated="true">
      ...
      <asset xsi:type="esdl:MobilityDemand" technicalLifetime="12.0" power="1346560876.7453334" originalIdInSource="transport_truck_using_hydrogen" name="MobilityDemand_c7a5" type="TRUCK" id="c7a59334-5290-41dc-98b4-95a842344741" efficiency="1.34274" fuelType="HYDROGEN" aggregated="true">
      ...
      <asset xsi:type="esdl:MobilityDemand" technicalLifetime="12.0" power="547974648.266366" originalIdInSource="transport_van_using_hydrogen" name="MobilityDemand_ac31" type="VAN" id="ac31f9cb-9168-4b42-b620-e5d90e6c738d" efficiency="0.03104" fuelType="HYDROGEN" aggregated="true">
      ...
      <asset xsi:type="esdl:Electrolyzer" fullLoadHours="2989" technicalLifetime="25.0" power="10000000.0" efficiency="0.66" originalIdInSource="energy_hydrogen_flexibility_p2g_electricity" name="Electrolyzer_b243" id="b243c807-ce6a-4625-8d24-7c2b57ac1ce3">
        ...
        <port xsi:type="esdl:OutPort" connectedTo="5959232b-a2fa-4139-95ec-ecee0f720475 b81f31d3-d8a6-4793-841e-b3ec946983d7 2f673e66-6d7c-4aad-a4ae-466255487f00" name="Out" id="d530c592-ce26-478b-b736-a55104b2ac61" carrier="b2418fd5-d4f8-451f-ae4e-6171b1e71103">
          <profile xsi:type="esdl:InfluxDBProfile" field="E3B" port="8086" host="http://influxdb" database="energy_profiles" name="energy_hydrogen_flexibility_p2g_electricity" profileType="POWER_IN_MW" id="d883ec8a-dc1a-47bf-b9ab-8bee87dfdcf5" measurement="standard_profiles_point"/>
        </port>
        ...
        <constraint xsi:type="esdl:RangedConstraint" name="NewRangedConstraint" id="9fa772e4-bbe6-4dc5-9273-b740ba19766a" attributeReference="power">
          <range xsi:type="esdl:Range" minValue="42000000000.0" id="2c97beb4-155d-47d2-a390-74d4712da7a9" maxValue="51000000000.0" name="NewRange">
      ...
      <asset xsi:type="esdl:GasConversion" technicalLifetime="25.0" power="369.0" efficiency="81.0" originalIdInSource="energy_hydrogen_steam_methane_reformer" type="SMR" name="GasConversion_bb6f" id="bb6f51a0-812f-4d9e-b23f-5259c54181d4">
        ...
        <costInformation xsi:type="esdl:CostInformation">
          ...
          <marginalCosts xsi:type="esdl:SingleValue" id="306f1033-d4ed-4d69-9e5d-499fd8580639" value="66.2">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" description="Cost in EUR/MWh" perMultiplier="MEGA" perUnit="WATTHOUR" unit="EURO" physicalQuantity="COST" id="e8be0c9e-7e91-4794-94eb-5398d1ca6374"/>
          </marginalCosts>
        ...
        <constraint xsi:type="esdl:RangedConstraint" name="NewRangedConstraint" id="8722dfeb-eff4-4439-99b1-60a0c9c036a1" attributeReference="power">
          <range xsi:type="esdl:Range" id="f4d62923-23ec-4291-afe2-2b137dca7b82" name="NewRange" maxValue="11716.0">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" multiplier="MEGA" id="f62593ee-8c2a-4cc3-910f-b8215d98b106" unit="WATT" physicalQuantity="POWER"/>
          </range>
        </constraint>
      ...
      <asset xsi:type="esdl:WindTurbine" technicalLifetime="25.0" originalIdInSource="energy_power_wind_turbine_inland or energy_power_wind_turbine_coastal" surfaceArea="200000" fullLoadHours="3000" power="3000000.0" name="WindTurbine_6411" id="64119197-a2d1-49d9-971a-08b978b99448">
        ...
        <constraint xsi:type="esdl:RangedConstraint" name="NewRangedConstraint" id="d0e08b2b-390a-4489-accd-fe639e424676" attributeReference="power">
          <range xsi:type="esdl:Range" minValue="20000000000.0" id="8bdf07f1-f43f-42c0-a4bc-e7ff73915312" maxValue="20000000000.0" name="NewRange">
            <profileQuantityAndUnit xsi:type="esdl:QuantityAndUnitType" multiplier="MEGA" id="b02625ac-c951-491a-87eb-c09b816493aa" unit="WATT" physicalQuantity="POWER"/>
          </range>
        </constraint>
      ...
      <asset xsi:type="esdl:Battery" name="Battery_082c" id="082ce57c-5559-42f9-8f4f-51a11195994b" capacity="50.0">
      ...
      <asset xsi:type="esdl:ElectricityCable" length="604.9" name="ElectricityCable_252a" id="252a8505-e833-4627-abc9-490c4704a4b8">
        <port xsi:type="esdl:InPort" name="In" id="2f673e66-6d7c-4aad-a4ae-466255487f00" carrier="b2418fd5-d4f8-451f-ae4e-6171b1e71103" connectedTo="d530c592-ce26-478b-b736-a55104b2ac61"/>
        <port xsi:type="esdl:OutPort" connectedTo="7db444bc-0c27-4f2e-84a6-5b05dc207f5b" name="Out" id="dbaecb4d-6837-4011-ace5-91558bff6374" carrier="b2418fd5-d4f8-451f-ae4e-6171b1e71103"/>
        <geometry xsi:type="esdl:Line" CRS="WGS84">
          <point xsi:type="esdl:Point" lat="52.08849875855484" lon="5.064654350280763"/>
