...
def test_parse_with_power_plants(energy_system_handler_with_power_plants):
    ...
    # There should be over 3000 MW of network gas present in the ESDL
    assert parser.get_parsed_inputs()['capacity_of_energy_power_combined_cycle_network_gas'] > 3000
