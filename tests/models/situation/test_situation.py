...
def slider_settings():
    return defaultdict(float, {
        ...
        'households_heater_district_heating_mt_steam_hot_water_share': 0.0,
        'households_heater_district_heating_lt_steam_hot_water_share': 0.0,
...
def slider_outcomes_nl_fixed():
    ...
    values = {
        ...
        'buildings_space_heater_district_heating_mt_steam_hot_water_share': {'present': 0., 'future': 0.},
        'buildings_space_heater_district_heating_lt_steam_hot_water_share': {'present': 0., 'future': 0.},
...
def slider_settings_present_business_park():
    return defaultdict(float, {
        ...
        'buildings_space_heater_district_heating_mt_steam_hot_water_share': 0.,
        'buildings_space_heater_district_heating_lt_steam_hot_water_share': 0.,
